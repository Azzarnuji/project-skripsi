...
@section('content')
    @include('Dashboard.GuruTU.Components.NavbarComponent', ['active' => 'data-siswa'])
    <div class="my-3">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="accordion" id="accordionPanelsStayOpenExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <a href="{{ url('download-file-format') }}"
                                        class="btn btn-primary">Download Import Format</a>
                                    <hr>
                                    <form action="/api/admin/tambahListSiswa" method="POST"
                                        enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">File Data
                                                Siswa</label>
                                            <input class="form-control" type="file" name="fileImport"
                                                id="formFile"
