    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-lg-0 mb-2 me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $active == 'pembayaran' ? 'active' : null }}"
                        aria-current="page" href="pembayaran">Pembayaran</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $active == 'data-siswa' ? 'active' : null }}"
                        aria-current="page" href="data-siswa">Data Siswa</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $active == 'ppdb' ? 'active' : null }}"
                        aria-current="page" href="ppdb">PPDB</a>
                </li>
