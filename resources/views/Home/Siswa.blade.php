                    ...
                    <div class="navigation">
                        <div id="smoothmenu1" class="ddsmoothmenu">
                            <ul>
                                ...
                                <li><a href="<?php echo url('pengumuman'); ?>">Pengumuman</a></li>
                                ...
                                <li>
                                    <div class="thumb">
                                        ...
                                        <img width="100" height="100"
                                            src="<?php echo \App\Helpers\Utils::base_url_web_sekolah() . 'assets/images/user_blank.png'; ?>" alt="" />
                                        <?php else:?>
                                        <img width="100" height="100"
                                            src="<?php echo \App\Helpers\Utils::base_url_web_sekolah() . 'assets/images/' . $photo; ?>" alt="" />
                                        <?php endif;?>
                                    </div>
