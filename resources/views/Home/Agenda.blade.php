                    ...
                    <div class="navigation">
                        <div id="smoothmenu1" class="ddsmoothmenu">
                            <ul>
                                ...
                                <li><a class="selected" href="<?php echo url('agenda'); ?>">Agenda</a></li>
                        ...
                        <div id="content2">
                            ...
                            <ul class="listing">
                                <?php
                                  ...
                                  ?>
                                <li>
                                    <div class="thumb"><a href=""><img width="126" height="106"
                                                src="<?php echo \App\Helpers\Utils::base_url_web_sekolah() . 'template/images/agenda.png'; ?>" alt="" /></a></div>
