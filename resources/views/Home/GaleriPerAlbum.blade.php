            ...
            <div id="wrapper_sec">
                ...
                <div id="content_section">
                    ...
                    <div class="gallery">
                        ...
                        <!-- Col1 -->
                        <?php
                        $b = (array) json_decode($data, true)[0];
                        ?>
                        <div class="categorydiv">
                            <ul>
                                <li><a href="<?php echo url('galeri'); ?>">Semua</a></li>
                                <?php
                                ...
                                <li><a href="<?php echo url('galeri/album/' . $alb_id); ?>" class="selected"><?php echo $alb_nama; ?></a></li>
                                <?php else:?>
                        ...
                        <div class="thumbdiv">
                            <ul>
                                <?php
                                    foreach ((array)json_decode($data,true) as $a) {
                                      $id=$a['galeri_id'];
